...
export default function Hero() {
    ...
    return (
        <>
            ...
            <section className=' hero relative w-full h-screen m-5 mx-auto top-[-16px] flex items-center flex-center'>

                <div className={`${styles.paddinX} absolute inset- top-[80px] w-100% flex flex-row items-start gap-5`}>
                    ...
                    <div className='  z-10'>
                        <h1 className={`${styles.heroHeadText} type text-cuarto`}> 
                            Hola, soy <span className='text-secundario'>Adonis  </span> 
                        </h1>
